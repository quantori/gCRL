# Panel_c for Norman2019: density plot contrasting real vs permuted T-Mex scores
...
mcc_folder <- file.path('../../../../results/real/Norman2019',
                         paste0('partial_mcc_permutation_', pct, 'pct_gamma', gamma, '_no_double'))
res_folder <- './Norman2019/Panel_c'
